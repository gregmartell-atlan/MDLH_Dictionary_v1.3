...
const ALLOWED_FILES = [
  ...
  // Demo mode data files - hardcoded for offline/GitHub Pages demo
  'demoData.js',                 // Demo mode data
  'demoProxyData.js',            // Comprehensive demo proxy data for ACME Analytics
  'useSnowflake.js',             // Contains demo mode query pattern matching (not actual queries)
