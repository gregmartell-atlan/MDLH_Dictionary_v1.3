...
## Session Context (Last Updated: 2025-12-10)

### This is the Master Project
This export (`EXPORT_20251209_071919`) is designated as the **master example** for the MDLH Dictionary project. Use this as the reference implementation.

### Quick Start (Single Command)
```bash
# Start both frontend and backend
cd /Users/greg.martell/Downloads/atlan-frontend-main/src/components/admin/integrations/browserExtension/BrowserExtensionConfiguration/MDLH_Dict/EXPORT_20251209_071919

# Terminal 1: Frontend
npm run dev
# Opens at: http://localhost:5173/MDLH_Dictionary_v1.3/
...
### Project Location
```
/Users/greg.martell/Downloads/atlan-frontend-main/src/components/admin/integrations/browserExtension/BrowserExtensionConfiguration/MDLH_Dict/EXPORT_20251209_071919
```

### Version Info
- **Export Date**: December 9, 2025
- **Version**: 1.3 (MDLH_Dictionary_v1.3)
- **Base Path**: `/MDLH_Dictionary_v1.3/`
- **Tests**: 472 passing
...
The parent `MDLH_Dict` folder contains:
- Current working copy (may have newer changes)
- Other exports: `BEFORE_TO_JSON_changes_20251207_*`, `AFTER_TO_JSON_changes_20251207_*`
- Documentation: `BACKEND_RESTART_DETECTION_EXPORT.md`, `CURSOR_MDLH_GUIDE.md`
